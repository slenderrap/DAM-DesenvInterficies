...
public class GameObjGradientsRadials implements GameObj {
    ...
    public void draw(GraphicsContext gc, GameData data) {
        ...
        String codi = """
            ...
            gc.fillRect(50, 50, 80, 50);
                """;
        Controller.drawCodi(gc, codi, 150, 60);
        ...
        codi = """
            ...
            gc.fillRect(50, 200, 80, 50);
                """;
        Controller.drawCodi(gc, codi, 150, 210);
        ...
        codi = """
            ...
            gc.fillRect(50, 300, 80, 50);
                """;
        Controller.drawCodi(gc, codi, 150, 310);
    }
}